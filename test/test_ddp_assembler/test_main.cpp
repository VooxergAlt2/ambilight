...
void test_runtime_frame_size_grows_beyond_old_920_led_capacity() {
    DdpAssembler assembler;

    constexpr std::size_t kLargePixels = 4096;
    constexpr std::size_t kLargeBytes =
        kLargePixels * sizeof(ambilight::Rgb8);
...
int main(int, char**) {
    ...
    RUN_TEST(test_runtime_frame_size_grows_beyond_old_920_led_capacity);
