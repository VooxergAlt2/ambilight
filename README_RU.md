...
Через WLED-compatible интерфейс Home Assistant доступны:

- включение/выключение;
- яркость через master и segment 0;
- RGB-цвет;
- `Ambilight` (AUTO);
- `Solid`, `Rainbow`, `Breathing`;
- `Warm White`, `Bias White`, `Sunset`, `Candle`, `Aurora`, `Twinkle`;
- скорость (`sx`) и интенсивность (`ix`) эффекта.
...
Один служебный/отключённый LED на каждой физической линии может быть задан отдельно от логического количества. Такой LED занимает адрес на проводе и всегда остаётся чёрным, а логические пиксели сдвигаются вокруг него. Например, при 230 логических LED и служебном первом LED физическая линия содержит 231 адрес, а DDP по-прежнему содержит 230 LED.
